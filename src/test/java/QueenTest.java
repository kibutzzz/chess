...
class QueenTest extends PieceTestTemplate {
  ...
  static Stream<Arguments> getTestCases() {
    return Stream.of(whiteQueenCombinedMovements(), blackQueenCombinedMovements());
  }

  private static Arguments whiteQueenCombinedMovements() {
    return Arguments.of(
  ...
  private static Arguments blackQueenCombinedMovements() {
    return Arguments.of(
